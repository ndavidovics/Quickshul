...
"><?php echo $shabbos;?>
      ...
      <span lang="he">מנחה:</span><?=$info[$tomorrow]['mincha'] ?>&nbsp;&nbsp;
       ...
       <?php echo $info[$tomorrow]['havdala'] ? '<span lang="he">הבדלה</span>:'. $info[$tomorrow]['havdala'].'' : ''; ?>
    	...
    	<hr/>
    	<div id="zmanim">
			<?php $todays_date = strtotime('today'); ?>
       <span lang="he">עלות:</span><?=date('g:i',get_alos($todays_date));?>&nbsp;
       <span lang="he">טלית:</span><?=date('g:i',get_misheyakir($todays_date));?>&nbsp;
       <span lang="he">הנץ:</span><?=date('g:i',get_sunrise($todays_date)) ?>&nbsp;
	   <span lang="he">מ"א:</span><?=date('g:i',get_ma_by_hour($todays_date,3)) ?>&nbsp;
       <span lang="he">שמע:</span><?=date('g:i',get_by_hour($todays_date,3)) ?><br/> 
	   <span lang="he">תפילה:</span><?=date('g:i',get_by_hour($todays_date,4)) ?> &nbsp;
       <span lang="he">חצות:</span><?=date('g:i',get_by_hour($todays_date,6)) ?> &nbsp;
       <span lang="he">מנחה גד':</span><?=date('g:i',get_by_hour($todays_date,6.5)) ?><br/>
       
       <span lang="he">פלג:</span><?=date('g:i',get_by_hour($todays_date,10.75)) ?> &nbsp;
       <span lang="he">שקיעה:</span><?=date('g:i',get_sunset($todays_date)) ?> &nbsp;
       <span lang="he">צאת:</span><?=date('g:i',get_tzeis($todays_date)) ?> &nbsp;
       <span lang="he">ר"ת:</span><?=date('g:i',get_rttzeis($todays_date)) ?></div>
    	<hr/>
